...
import com.dauction.infrastructure.repository.factory.WalletFactory;
...
public class WalletRepository implements IWalletRepository
{
	...
	{
		//StringBuilder sbSql = new StringBuilder("INSERT INTO wallet(소유자id,address,잔액) ");
		//sbSql.append("VALUES(?,?,?)");
		try{
	...
	@Override
	public int updateBalance(final String wAddress, final BigDecimal balance)
	{
